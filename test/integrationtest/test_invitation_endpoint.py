...
class Test:
    ...
    def test_blank_field(self):
        response = app.test_client().patch(self.path, headers={'token': self.token}, json={'event_id': 1})
        assert json.loads(response.data.decode('utf-8')) == {'message': {'status': self.mess}}
